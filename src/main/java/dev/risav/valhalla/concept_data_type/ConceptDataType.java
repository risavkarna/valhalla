...
public class ConceptDataType {
    ...
    @OneToMany(mappedBy = "conceptDatatype")
    private Set<Concept> conceptDatatypeConcepts;
    ...
    public Set<Concept> getConceptDatatypeConcepts() {
        return conceptDatatypeConcepts;
    }

    public void setConceptDatatypeConcepts(final Set<Concept> conceptDatatypeConcepts) {
        this.conceptDatatypeConcepts = conceptDatatypeConcepts;
    }
