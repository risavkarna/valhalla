...
public class EncounterType {
    ...
    private Set<Encounter> encounterTypeEncounters;
    ...
    public Set<Encounter> getEncounterTypeEncounters() {
        return encounterTypeEncounters;
    }

    public void setEncounterTypeEncounters(final Set<Encounter> encounterTypeEncounters) {
        this.encounterTypeEncounters = encounterTypeEncounters;
    }
