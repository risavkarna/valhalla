...
public class OrderRoute {
    ...
    private Set<Order> orderRouteOrders;
    ...
    public Set<Order> getOrderRouteOrders() {
        return orderRouteOrders;
    }

    public void setOrderRouteOrders(final Set<Order> orderRouteOrders) {
        this.orderRouteOrders = orderRouteOrders;
    }
