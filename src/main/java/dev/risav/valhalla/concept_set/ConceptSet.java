...
public class ConceptSet {
    ...
    @OneToMany(mappedBy = "conceptSet")
    private Set<Concept> conceptSetConcepts;
    ...
    public Set<Concept> getConceptSetConcepts() {
        return conceptSetConcepts;
    }

    public void setConceptSetConcepts(final Set<Concept> conceptSetConcepts) {
        this.conceptSetConcepts = conceptSetConcepts;
    }
