...
public class OrderType {
    ...
    private Set<Order> orderTypeOrders;
    ...
    public Set<Order> getOrderTypeOrders() {
        return orderTypeOrders;
    }

    public void setOrderTypeOrders(final Set<Order> orderTypeOrders) {
        this.orderTypeOrders = orderTypeOrders;
    }
