...
public class OrderFrequency {
    ...
    private Set<Order> orderFrequencyOrders;
    ...
    public Set<Order> getOrderFrequencyOrders() {
        return orderFrequencyOrders;
    }

    public void setOrderFrequencyOrders(final Set<Order> orderFrequencyOrders) {
        this.orderFrequencyOrders = orderFrequencyOrders;
    }
