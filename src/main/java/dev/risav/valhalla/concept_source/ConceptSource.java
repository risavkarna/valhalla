...
public class ConceptSource {
    ...
    @OneToMany(mappedBy = "conceptSource")
    private Set<Concept> conceptSourceConcepts;
    ...
    public Set<Concept> getConceptSourceConcepts() {
        return conceptSourceConcepts;
    }

    public void setConceptSourceConcepts(final Set<Concept> conceptSourceConcepts) {
        this.conceptSourceConcepts = conceptSourceConcepts;
    }
