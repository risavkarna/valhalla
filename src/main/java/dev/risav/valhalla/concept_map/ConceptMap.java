...
public class ConceptMap {
    ...
    private Set<Concept> conceptMapConcepts;
    ...
    public Set<Concept> getConceptMapConcepts() {
        return conceptMapConcepts;
    }

    public void setConceptMapConcepts(final Set<Concept> conceptMapConcepts) {
        this.conceptMapConcepts = conceptMapConcepts;
    }
